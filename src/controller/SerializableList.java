 ...
 *
 *        Klasa rozszerza dostępną ArrayList o możliwość zapisu i ładowania z
 *        pliku
 */
...
public class SerializableList<T extends Serializable>
    ...
    public static <T extends Serializable> SerializableList<T> loadFromFile(String filename) {
        try {
